  ...
  root.innerHTML = `
    ...
    <div class="cb-window" id="cb-window" role="dialog" aria-modal="false" aria-label="Chat with Mahima's assistant">
      ...
      <form class="cb-input-container" id="cb-form" autocomplete="off">
        ...
        <div class="cb-credit-bar">
          <span>Dev by <strong>@abhimanyus1997</strong></span>
          <span class="cb-credit-dot">&bull;</span>
          <span>Designed by <strong>@designwithmahima</strong></span>
        </div>
      </form>
    </div>
  `;
